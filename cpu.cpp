...
int Cpu::ExecuteOpcode()
{
	...
	switch(Opcode)
	{
		...
		break;
		case 0x2F: Bit::Set(AF.lo, FLAG_N); Bit::Set(AF.lo, FLAG_H); AF.hi ^= 1; Cycles += 4; break; // CPL
		case 0x37: Bit::Reset(AF.lo, FLAG_N); Bit::Reset(AF.lo, FLAG_H); Bit::Set(AF.lo, FLAG_C); Cycles += 4; break; // SCF
		case 0x3F: // CCF
			Bit::Reset(AF.lo, FLAG_N); 
			Bit::Reset(AF.lo, FLAG_H);
		...
		// 8-bit add
		case 0x80: ADD_8Bit(AF.hi, BC.hi); Cycles += 4; break; // ADD A,B
		case 0x81: ADD_8Bit(AF.hi, BC.lo); Cycles += 4; break; // ADD A,C
		case 0x82: ADD_8Bit(AF.hi, DE.hi); Cycles += 4; break; // ADD A,D
		case 0x83: ADD_8Bit(AF.hi, DE.lo); Cycles += 4; break; // ADD A,E
		case 0x84: ADD_8Bit(AF.hi, HL.hi); Cycles += 4; break; // ADD A,H
		case 0x85: ADD_8Bit(AF.hi, HL.lo); Cycles += 4; break; // ADD A,L
		case 0x86: ADD_8Bit(AF.hi, Memory::ReadByte(HL.reg)); Cycles += 8; break; // ADD A,(HL)
		case 0x87: ADD_8Bit(AF.hi, AF.hi); Cycles += 4; break; // ADD A,A
		case 0x88: ADD_8Bit(AF.hi, BC.hi, true); Cycles += 4; break; // ADC A,B
		case 0xC6: ADD_8Bit(AF.hi, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // ADD A,d8
		// 8-bit add + carry
		case 0x89: ADD_8Bit(AF.hi, BC.lo, true); Cycles += 4; break; // ADC A,C
		case 0x8A: ADD_8Bit(AF.hi, DE.hi, true); Cycles += 4; break; // ADC A,D
		case 0x8B: ADD_8Bit(AF.hi, DE.lo, true); Cycles += 4; break; // ADC A,E
		case 0x8C: ADD_8Bit(AF.hi, HL.hi, true); Cycles += 4; break; // ADC A,H
		case 0x8D: ADD_8Bit(AF.hi, HL.lo, true); Cycles += 4; break; // ADC A,L
		case 0x8E: ADD_8Bit(AF.hi, Memory::ReadByte(HL.reg), true); Cycles += 8; break; // ADC A,(HL)
		case 0x8F: ADD_8Bit(AF.hi, AF.hi, true); Cycles += 4; break; // ADC A,A
		case 0xCE: ADD_8Bit(AF.hi, Memory::ReadByte(PC), true); PC++; Cycles += 8; break; // ADC A,d8ADD
		// 16-bit add
		case 0x09: ADD_16Bit(HL.reg, BC.reg); Cycles += 8; break; // ADD HL,BC
		case 0x19: ADD_16Bit(HL.reg, DE.reg); Cycles += 8; break; // ADD HL,DE
		case 0x29: ADD_16Bit(HL.reg, HL.reg); Cycles += 8; break; // ADD HL,HL
		case 0x39: ADD_16Bit(HL.reg, SP.reg); Cycles += 8; break; // ADD HL,SP
		case 0xE8: // ADD SP,r8
		{
		...
		break;
		// 8-bit sub
		case 0x90: SUB_8Bit(AF.hi, BC.hi); Cycles += 4; break; // SUB B
		case 0x91: SUB_8Bit(AF.hi, BC.lo); Cycles += 4; break; // SUB C
		case 0x92: SUB_8Bit(AF.hi, DE.hi); Cycles += 4; break; // SUB D
		case 0x93: SUB_8Bit(AF.hi, DE.lo); Cycles += 4; break; // SUB E
		case 0x94: SUB_8Bit(AF.hi, HL.hi); Cycles += 4; break; // SUB H
		case 0x95: SUB_8Bit(AF.hi, HL.lo); Cycles += 4; break; // SUB L
		case 0x96: SUB_8Bit(AF.hi, Memory::ReadByte(HL.reg)); Cycles += 8; break; // SUB (HL)
		case 0x97: SUB_8Bit(AF.hi, AF.hi); Cycles += 4; break; // SUB A
		case 0xD6: SUB_8Bit(AF.hi, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // SUB d8
		// 8-bit sub + carry
		case 0x98: SUB_8Bit(AF.hi, BC.hi, true); Cycles += 4; break; // SBC A,B
		case 0x99: SUB_8Bit(AF.hi, BC.lo, true); Cycles += 4; break; // SBC A,C
		case 0x9A: SUB_8Bit(AF.hi, DE.hi, true); Cycles += 4; break; // SBC A,D
		case 0x9B: SUB_8Bit(AF.hi, DE.lo, true); Cycles += 4; break; // SBC A,E
		case 0x9C: SUB_8Bit(AF.hi, HL.hi, true); Cycles += 4; break; // SBC A,H
		case 0x9D: SUB_8Bit(AF.hi, HL.lo, true); Cycles += 4; break; // SBC A,L
		case 0x9E: SUB_8Bit(AF.hi, Memory::ReadByte(HL.reg), true); Cycles += 8; break; // SBC A,(HL)
		case 0x9F: SUB_8Bit(AF.hi, AF.hi, true); Cycles += 4; break; // SBC A,A
		case 0xDE: SUB_8Bit(AF.hi, Memory::ReadByte(PC), true); PC++; Cycles += 8; break; // SBC A,d8
		// 8-bit and
		case 0xA0: AND_8Bit(AF.hi, BC.hi); Cycles += 4; break; // AND B
		case 0xA1: AND_8Bit(AF.hi, BC.lo); Cycles += 4; break; // AND C
		case 0xA2: AND_8Bit(AF.hi, DE.hi); Cycles += 4; break; // AND D
		case 0xA3: AND_8Bit(AF.hi, DE.lo); Cycles += 4; break; // AND E
		case 0xA4: AND_8Bit(AF.hi, HL.hi); Cycles += 4; break; // AND H
		case 0xA5: AND_8Bit(AF.hi, HL.lo); Cycles += 4; break; // AND L
		case 0xA6: AND_8Bit(AF.hi, Memory::ReadByte(HL.reg)); Cycles += 8; break; // AND (HL)
		case 0xA7: AND_8Bit(AF.hi, AF.hi); Cycles += 4; break; // AND A
		case 0xE6: AND_8Bit(AF.hi, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // AND d8		
		// 8-bit or
		case 0xB0: OR_8Bit(AF.hi, BC.hi); Cycles += 4; break; // OR B
		case 0xB1: OR_8Bit(AF.hi, BC.lo); Cycles += 4; break; // OR C
		case 0xB2: OR_8Bit(AF.hi, DE.hi); Cycles += 4; break; // OR D
		case 0xB3: OR_8Bit(AF.hi, DE.lo); Cycles += 4; break; // OR E
		case 0xB4: OR_8Bit(AF.hi, HL.hi); Cycles += 4; break; // OR H
		case 0xB5: OR_8Bit(AF.hi, HL.lo); Cycles += 4; break; // OR L
		case 0xB6: OR_8Bit(AF.hi, Memory::ReadByte(HL.reg)); Cycles += 8; break; // OR (HL)
		case 0xB7: OR_8Bit(AF.hi, AF.hi); Cycles += 4; break; // OR A
		case 0xF6: OR_8Bit(AF.hi, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // OR d8
		// 8-bit xor
		case 0xA8: XOR_8Bit(AF.hi, BC.hi); Cycles += 4; break; // XOR B
		case 0xA9: XOR_8Bit(AF.hi, BC.lo); Cycles += 4; break; // XOR C
		case 0xAA: XOR_8Bit(AF.hi, DE.hi); Cycles += 4; break; // XOR D 
		case 0xAB: XOR_8Bit(AF.hi, DE.lo); Cycles += 4; break; // XOR E
		case 0xAC: XOR_8Bit(AF.hi, HL.hi); Cycles += 4; break; // XOR H
		case 0xAD: XOR_8Bit(AF.hi, HL.lo); Cycles += 4; break; // XOR L
		case 0xAE: XOR_8Bit(AF.hi, Memory::ReadByte(HL.reg)); Cycles += 8; break; // XOR (HL)
		case 0xAF: XOR_8Bit(AF.hi, AF.hi); Cycles += 4; break; // XOR A
		case 0xEE: XOR_8Bit(AF.hi, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // XOR d8
		// 8-bit dec
		case 0x05: DEC_8Bit(BC.hi, 3); Cycles += 4; break; // DEC B
		case 0x0D: DEC_8Bit(BC.lo, 3); Cycles += 4; break; // DEC C
		case 0x15: DEC_8Bit(DE.hi, 3); Cycles += 4; break; // DEC D
		case 0x1D: DEC_8Bit(DE.lo, 3); Cycles += 4; break; // DEC E
		case 0x25: DEC_8Bit(HL.hi, 3); Cycles += 4; break; // DEC H
		case 0x2D: DEC_8Bit(HL.lo, 3); Cycles += 4; break; // DEC L
		case 0x3D: DEC_8Bit(AF.hi, 3); Cycles += 4; break; // DEC A
		// 16-bit dec
		case 0x0B: DEC_16Bit(BC.reg); Cycles += 8; break; // DEC BC
		case 0x1B: DEC_16Bit(DE.reg); Cycles += 8; break; // DEC DE
		case 0x2B: DEC_16Bit(HL.reg); Cycles += 8; break; // DEC HL
		case 0x3B: DEC_16Bit(SP.reg); Cycles += 8; break; // DEC SP
		// 8-bit inc
		case 0x04: INC_8Bit(BC.hi, 3); Cycles += 4; break; // INC B
		case 0x0C: INC_8Bit(BC.lo, 3); Cycles += 4; break; // INC C
		case 0x14: INC_8Bit(DE.hi, 3); Cycles += 4; break; // INC D
		case 0x1C: INC_8Bit(DE.lo, 4); Cycles += 4; break; // INC E
		case 0x24: INC_8Bit(HL.hi, 3); Cycles += 4; break; // INC H
		case 0x2C: INC_8Bit(HL.lo, 3); Cycles += 4; break; // INC L
		case 0x3C: INC_8Bit(AF.hi, 3); Cycles += 4; break; // INC A
		// 16-bit inc
		case 0x03: INC_16Bit(BC.reg); Cycles += 8; break; // INC BC
		case 0x13: INC_16Bit(DE.reg); Cycles += 8; break; // INC DE
		case 0x23: INC_16Bit(HL.reg); Cycles += 8; break; // INC HL
		case 0x33: INC_16Bit(SP.reg); Cycles += 8; break; // INC SP
		// 8-bit compare
		case 0xB8: COMPARE_8Bit(AF.hi, BC.hi); Cycles += 4; break; // CP B
		case 0xB9: COMPARE_8Bit(AF.hi, BC.lo); Cycles += 4; break; // CP C
		case 0xBA: COMPARE_8Bit(AF.hi, DE.hi); Cycles += 4; break; // CP D
		case 0xBB: COMPARE_8Bit(AF.hi, DE.lo); Cycles += 4; break; // CP E
		case 0xBC: COMPARE_8Bit(AF.hi, HL.hi); Cycles += 4; break; // CP H
		...
		case 0x0E: LOAD_8Bit(BC.lo, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // LD C,d8
		case 0x1A: LOAD_8Bit(AF.hi, Memory::ReadByte(DE.reg)); Cycles += 8; break; // LD A,(DE)
		case 0x16: LOAD_8Bit(DE.hi, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // LD D,d8
		case 0x1E: LOAD_8Bit(DE.lo, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // LD E,d8
		case 0x26: LOAD_8Bit(HL.hi, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // LD H,d8
		case 0x2A: LOAD_8Bit(AF.hi, Memory::ReadByte(HL.reg)); INC_16Bit(HL.reg); Cycles += 8; break; // LD A,(HL+)
		case 0x2E: LOAD_8Bit(HL.lo, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // LD L,d8 
		case 0x3A: LOAD_8Bit(AF.hi, Memory::ReadByte(HL.reg)); DEC_16Bit(HL.reg); Cycles += 8; break; // LD A,(HL-)
		case 0x3E: LOAD_8Bit(AF.hi, Memory::ReadByte(PC)); PC++; Cycles += 8; break; // LD A,d8
		case 0x40: LOAD_8Bit(BC.hi, BC.hi); Cycles += 4; break; // LD B,B
		case 0x41: LOAD_8Bit(BC.hi, BC.lo); Cycles += 4; break; // LD B,C
		case 0x42: LOAD_8Bit(BC.hi, DE.hi); Cycles += 4; break; // LD B,D
		case 0x43: LOAD_8Bit(BC.hi, DE.lo); Cycles += 4; break; // LD B,E
		case 0x44: LOAD_8Bit(BC.hi, HL.hi); Cycles += 4; break; // LD B,H
		case 0x45: LOAD_8Bit(BC.hi, HL.lo); Cycles += 4; break; // LD B,L
		case 0x46: LOAD_8Bit(BC.hi, Memory::ReadByte(HL.reg)); Cycles += 8; break; // LD B,(HL) 
		case 0x47: LOAD_8Bit(BC.hi, AF.hi); Cycles += 4; break; // LD B,A
		case 0x48: LOAD_8Bit(BC.lo, BC.hi); Cycles += 4; break; // LD C,B
		case 0x49: LOAD_8Bit(BC.lo, BC.lo); Cycles += 4; break; // LD C,C
		case 0x4A: LOAD_8Bit(BC.lo, DE.hi); Cycles += 4; break; // LD C,D
		case 0x4B: LOAD_8Bit(BC.lo, DE.lo); Cycles += 4; break; // LD C,E
		case 0x4C: LOAD_8Bit(BC.lo, HL.hi); Cycles += 4; break; // LD C,H
		case 0x4D: LOAD_8Bit(BC.lo, HL.lo); Cycles += 4; break; // LD C,L
		case 0x4E: LOAD_8Bit(BC.lo, Memory::ReadByte(HL.reg)); Cycles += 8; break; // LD C,(HL)
		case 0x4F: LOAD_8Bit(BC.lo, AF.hi); Cycles += 4; break; // LD C,A
		case 0x50: LOAD_8Bit(DE.hi, BC.hi); Cycles += 4; break; // LD D,B
		case 0x51: LOAD_8Bit(DE.hi, BC.lo); Cycles += 4; break; // LD D,C
		case 0x52: LOAD_8Bit(DE.hi, DE.hi); Cycles += 4; break; // LD D,D
		case 0x53: LOAD_8Bit(DE.hi, DE.lo); Cycles += 4; break; // LD D,E
		case 0x54: LOAD_8Bit(DE.hi, HL.hi); Cycles += 4; break; // LD D,H
		case 0x55: LOAD_8Bit(DE.hi, HL.lo); Cycles += 4; break; // LD D,L
		case 0x56: LOAD_8Bit(DE.hi, Memory::ReadByte(HL.reg)); Cycles += 8; break; // LD D,(HL)
		case 0x57: LOAD_8Bit(DE.hi, AF.hi); Cycles += 4; break; // LD D,A
		case 0x58: LOAD_8Bit(DE.lo, BC.hi); Cycles += 4; break; // LD E,B
		case 0x59: LOAD_8Bit(DE.lo, BC.lo); Cycles += 4; break; // LD E,C
		case 0x5A: LOAD_8Bit(DE.lo, DE.hi); Cycles += 4; break; // LD E,D
		case 0x5B: LOAD_8Bit(DE.lo, DE.lo); Cycles += 4; break; // LD E,E
		case 0x5C: LOAD_8Bit(DE.lo, HL.hi); Cycles += 4; break; // LD E,H
		case 0x5D: LOAD_8Bit(DE.lo, HL.lo); Cycles += 4; break; // LD E,L
		case 0x5E: LOAD_8Bit(DE.lo, Memory::ReadByte(HL.reg)); Cycles += 8; break; // LD E,(HL)
		case 0x5F: LOAD_8Bit(DE.lo, AF.hi); Cycles += 4; break; // LD E,A
		case 0x60: LOAD_8Bit(HL.hi, BC.hi); Cycles += 4; break; // LD H,B
		case 0x61: LOAD_8Bit(HL.hi, BC.lo); Cycles += 4; break; // LD H,C
		case 0x62: LOAD_8Bit(HL.hi, DE.hi); Cycles += 4; break; // LD H,D
		case 0x63: LOAD_8Bit(HL.hi, DE.lo); Cycles += 4; break; // LD H,E
		case 0x64: LOAD_8Bit(HL.hi, HL.hi); Cycles += 4; break; // LD H,H
		case 0x65: LOAD_8Bit(HL.hi, HL.lo); Cycles += 4; break; // LD H,L
		case 0x66: LOAD_8Bit(HL.hi, Memory::ReadByte(HL.reg)); Cycles += 8; break; // LD H,(HL)
		case 0x67: LOAD_8Bit(HL.hi, AF.hi); Cycles += 4; break; // LD H,A
		case 0x68: LOAD_8Bit(HL.lo, BC.hi); Cycles += 4; break; // LD L,B
		case 0x69: LOAD_8Bit(HL.lo, BC.lo); Cycles += 4; break; // LD L,C
		case 0x6A: LOAD_8Bit(HL.lo, DE.hi); Cycles += 4; break; // LD L,D
		case 0x6B: LOAD_8Bit(HL.lo, DE.lo); Cycles += 4; break; // LD L,E
		case 0x6C: LOAD_8Bit(HL.lo, HL.hi); Cycles += 4; break; // LD L,H
		case 0x6D: LOAD_8Bit(HL.lo, HL.lo); Cycles += 4; break; // LD L,L
		case 0x6E: LOAD_8Bit(HL.lo, Memory::ReadByte(HL.reg)); Cycles += 8; break; // LD L,(HL)
		case 0x6F: LOAD_8Bit(HL.lo, AF.hi); Cycles += 4; break; // LD L,A
		case 0x78: LOAD_8Bit(AF.hi, BC.hi); Cycles += 4; break; // LD A,B
		case 0x79: LOAD_8Bit(AF.hi, BC.lo); Cycles += 4; break; // LD A,C
		case 0x7A: LOAD_8Bit(AF.hi, DE.hi); Cycles += 4; break; // LD A,D
		case 0x7B: LOAD_8Bit(AF.hi, DE.lo); Cycles += 4; break; // LD A,E
		case 0x7C: LOAD_8Bit(AF.hi, HL.hi); Cycles += 4; break; // LD A,H
		case 0x7D: LOAD_8Bit(AF.hi, HL.lo); Cycles += 4; break; // LD A,L 
		...
		break;
		case 0xF9: LOAD_16Bit(SP.reg, HL.reg); Cycles += 8; break; // LD SP,HL
		case 0xFA: LOAD_16Bit(AF.reg, Memory::ReadWord(PC)); PC += 2; Cycles += 16; break; // LD A,(a16)
		case 0x08: // LD (a16),SP
		{
			WORD nn = Memory::ReadWord(PC);
		...
		break;
		// 8-bit write
		case 0x02: WRITE_8Bit(BC.reg, AF.hi); Cycles += 8; break; // LD (BC),A
		case 0x12: WRITE_8Bit(DE.reg, AF.hi); Cycles += 8; break; // LD (DE),A
		case 0x22: WRITE_8Bit(HL.reg, AF.hi); INC_16Bit(HL.reg); Cycles += 12; break; // LD (HL+),A
		case 0x32: WRITE_8Bit(HL.reg, AF.hi); DEC_16Bit(HL.reg); Cycles += 12; break; // LD (HL-),A
		case 0x36: WRITE_8Bit(HL.reg, Memory::ReadByte(PC)); PC++; Cycles += 12; break; // LD (HL),d8
		case 0x70: WRITE_8Bit(HL.reg, BC.hi); Cycles += 8; break; // LD (HL),B
		case 0x71: WRITE_8Bit(HL.reg, BC.lo); Cycles += 8; break; // LD (HL),C
		case 0x72: WRITE_8Bit(HL.reg, DE.hi); Cycles += 8; break; // LD (HL),D
		case 0x73: WRITE_8Bit(HL.reg, DE.lo); Cycles += 8; break; // LD (HL),E
		case 0x74: WRITE_8Bit(HL.reg, HL.hi); Cycles += 8; break; // LD (HL),H
		case 0x75: WRITE_8Bit(HL.reg, HL.lo); Cycles += 8; break; // LD (HL),L
		case 0x77: WRITE_8Bit(HL.reg, AF.hi); Cycles += 8; break; // LD (HL),A
		case 0xE2: WRITE_8Bit(0xFF00 + BC.lo, AF.hi); PC++; Cycles += 12; break; // LD (C),A
		case 0xEA: WRITE_8Bit(Memory::ReadWord(PC), AF.hi); PC += 2; Cycles += 16; break; // LD (a16),A
		case 0xF2: WRITE_8Bit(0xFF00 + AF.hi, Memory::ReadByte(BC.lo)); PC++; Cycles += 8; break; // LD A,(C)
		...
		case 0xC8: if (Bit::Get(AF.lo, FLAG_Z)) RETURN(); Cycles += 8; break; // RET Z
		case 0xD0: if (!Bit::Get(AF.lo, FLAG_C)) RETURN(); Cycles += 8; break; // RET NC
		case 0xD8: if (Bit::Get(AF.lo, FLAG_C)) RETURN(); Cycles += 8; break;  // RET C
		case 0xD9: RETURN(); Interrupt::MasterSwitch = true; Cycles += 16; break; // RETI
		// restarts
		case 0xC7: RESTART(0x00); Cycles += 16; break; // RST 00H
		case 0xCF: RESTART(0x08); Cycles += 16; break; // RST 08H
		case 0xD7: RESTART(0x10); Cycles += 16; break; // RST 10H
		case 0xDF: RESTART(0x18); Cycles += 16; break; // RST 18H
		case 0xE7: RESTART(0x20); Cycles += 16; break; // RST 20H
		case 0xEF: RESTART(0x28); Cycles += 16; break; // RST 28H
		case 0xF7: RESTART(0x30); Cycles += 16; break; // RST 30H
		case 0xFF: RESTART(0x38); Cycles += 16; break; // RST 38H
		// push
